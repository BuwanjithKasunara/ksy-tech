...
class RibbonCanvas {
    constructor(canvasId) {
        ...
        this.animate = () => {
            ...
            if (rect) {
                ...
                const centerGlow = this.ctx.createRadialGradient(width * 0.45, height * 0.65, 30, width * 0.45, height * 0.65, width * 0.55);
    ...
    draw3DVolumetricBand(apexYRatio, thickness, tilt, speedFactor, baseColor, highlightAlpha) {
        var _a;
        const rect = (_a = this.canvas.parentElement) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect();
        if (!rect)
            return;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    modalCloseBtn === null || modalCloseBtn === void 0 ? void 0 : modalCloseBtn.addEventListener('click', closeMemberModal);
    modalBackdrop === null || modalBackdrop === void 0 ? void 0 : modalBackdrop.addEventListener('click', (e) => {
    ...
    const toggleTeamCollapse = () => {
        ...
        if (isExpanded) {
            ...
            if (seeMoreText)
                seeMoreText.textContent = 'See More Team Members';
            document.body.classList.remove('is-expanded');
            headerToggle === null || headerToggle === void 0 ? void 0 : headerToggle.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
        }
    };
